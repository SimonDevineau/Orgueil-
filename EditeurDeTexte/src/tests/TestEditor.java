...
public class TestEditor {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        invoke(c, "\\n",SLEEP_TIME);
        invoke(c, " ----Une insertion après avoir remonté le curseur!---- ", SLEEP_TIME);
        for(int i = 0 ; i < 70 ; i++)
        	invoke(c, "\\o", SLEEP_TIME_FOR);
	...
	public static void invoke(Controller c, String text, int sleepTime) throws InterruptedException {
