...
public final class BufferMemory {
	 ...
	 * @param aStorable the element to add at the end of the stack
	 */
	 ...
	 * @param storable, the IStorable to add on top of the stack
	 */
	 ...
	 * @param aStorable, the IStorable to remove
	 */
