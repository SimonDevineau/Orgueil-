 ...
 * Factory.java 
 * This class is supposed to be, with Editor, the only classes which are public
 * because it is required to come through this class to instanciate the other objects.
 */
